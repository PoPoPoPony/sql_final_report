<?php
    ...
    $sql = "select top 1 dep, grade, register_info.S_ID, name, sex, student_info.ID, bDate, email, phone, condition, time, unit, teacher, f_count, s_count, w_count, career, income, other, wish, academic_score.score_1, academic_score.score_2, conduct_score.score_1, conduct_score.score_2 ";
